    ...
    <div className="w-full relative rounded-2xl overflow-hidden bg-linear-to-br from-red-600 to-red-800 shadow-[0_8px_30px_rgba(37,99,235,0.2)]">
      ...
      <div className="relative z-10 px-6 py-14 sm:px-12 sm:py-20 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto shrink-0">
          <Button size="lg" className="h-14 px-8 text-[15px] font-semibold rounded-xl bg-white text-red-700 hover:bg-slate-50 hover:text-red-800 shadow-lg shadow-black/10 transition-transform hover:scale-[1.02] active:scale-[0.98]">
