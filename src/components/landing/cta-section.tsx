        ...
        <div className="relative rounded-[3rem] overflow-hidden bg-slate-950 p-10 md:p-24 text-center flex flex-col items-center justify-center min-h-125 shadow-2xl border border-slate-800">
          ...
          <div className="absolute inset-0 overflow-hidden z-0">
            <div className="absolute inset-0">
              <div className="absolute top-[-30%] left-[-10%] w-[60%] h-[60%] rounded-[100%] bg-red-600/40 blur-[120px]" />
              <div className="absolute bottom-[-30%] right-[-10%] w-[60%] h-[60%] rounded-[100%] bg-orange-600/40 blur-[120px]" />
            </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full sm:w-auto">
              <Button render={<Link href="/sign-up" />} className="w-full sm:w-auto h-16 px-10 rounded-full bg-red-600 hover:bg-red-500 text-white text-xl font-bold shadow-[0_0_40px_rgba(222, 59, 61,0.4)] hover:shadow-[0_0_60px_rgba(222, 59, 61,0.6)] hover:-translate-y-1 transition-all duration-300 border-none">
